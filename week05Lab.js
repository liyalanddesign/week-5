 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting("Vitalli", "Lincoln");
myGreeting.hello();
...
let yourBook = new Book("War and Piece", "Fiodor Dostoyevsky");
...
fruit1.printDescription();
fruit2.printDescription();
...
// Look at the provided code below. Notice how Student and Teacher inherit from the Person
// class through the use of the "extends" and "super" key words. Also, how Student has a
// redefined details method that is more appropriate than the details method it would have
